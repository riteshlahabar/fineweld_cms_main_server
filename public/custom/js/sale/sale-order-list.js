    ...
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            columns: [
                ...
                {data: 'sale_order_quantity', name: 'sale_order_quantity', orderable: false, searchable: false},
                {data: 'sold_quantity', name: 'sold_quantity', orderable: false, searchable: false},
