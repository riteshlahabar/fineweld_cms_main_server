...
`<div>
    ...
    <small class="text-muted">${data.billing_address ?? ''}</small><br>

    <!-- ${balanceText}, <small>${bottomText + '<i class="fadeIn text-primary bx bx-mobile"></i> ' + (data.mobile ? data.mobile : '-')}</small> -->
...
$(document).on('select2:select', '.party-ajax', function (e) {
