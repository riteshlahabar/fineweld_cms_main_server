...
use App\Http\Controllers\SupportPortal\LiveMapController;
...
Route::post('/save-admin-token', function (Request $request) {
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'settings', 'middleware' => ['can:tally.integration.view']], function () {
    ...
    ->name('tickets.closed');      //closed ticket
        ...
        Route::get('/pdf/{id}', [TicketController::class, 'generatePdf'])
            ->middleware('can:ticket.view')
            ->name('tickets.pdf');
        Route::post('/change-status', [TicketController::class, 'changeStatus'])
            ->middleware('can:ticket.status')
            ->name('tickets.change.status');
            
        //for assigning engineer to ticket from dropdown
    Route::post('/assign-engineer', [TicketController::class, 'assignEngineer'])
    ->middleware('can:ticket.assign')
    ->name('tickets.assign.engineer');
    
        Route::get('/live-map-data', [LiveMapController::class, 'liveMapData'])
    ->middleware('can:ticket.track')
    ->name('tickets.live.map.data');
    
    Route::get('/visits/{id}', [TicketController::class, 'visits'])
    ->middleware('can:ticket.view')
    ->name('tickets.visits');
    ...
    Route::group(['prefix' => 'sale/invoice'], function () {
        ...
        Route::post('/einvoice/generate/{id}', [EInvoiceController::class, 'generateIrn'])->middleware('can:sale.invoice.edit')->name('sale.invoice.einvoice.generate');
        Route::post('/einvoice/cancel/{id}', [EInvoiceController::class, 'cancelIrn'])->middleware('can:sale.invoice.edit')->name('sale.invoice.einvoice.cancel');
        Route::post('/ewaybill/generate/{id}', [EInvoiceController::class, 'generateEwb'])->middleware('can:sale.invoice.edit')->name('sale.invoice.ewaybill.generate');
        Route::post('/ewaybill/cancel/{id}', [EInvoiceController::class, 'cancelEwb'])->middleware('can:sale.invoice.edit')->name('sale.invoice.ewaybill.cancel');
        Route::post('/einvoice/sync/{id}', [EInvoiceController::class, 'syncIrn'])->middleware('can:sale.invoice.view')->name('sale.invoice.einvoice.sync');
