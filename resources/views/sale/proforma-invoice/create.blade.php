                            ...
                            <div class="col-12 col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <x-label for="quotation_code" name="Proforma Invoice ID" />
                                                <!--  -->
                                                <div class="input-group mb-3">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            {{-- OLD NOTE FIELD (COMMENTED FOR TERMS & CONDITIONS) --}}
{{--
<div class="col-md-8">
...
<div class="col-md-12">
<label>Other</label>
<textarea name="terms[other]" class="form-control" rows="2"></textarea>
</div>
                                                   ...
                                                   <tbody>
                                                      @if(app('company')['is_enable_carrier_charge'])
                                                       <tr>
                                                         ...
                                                         <td class="w-50">
                                                            <x-input type="text" additionalClasses="text-end cu_numeric" name="shipping_charge" :required="true" placeholder="Shipping Charge" value="0"/>
                                                        </td>
                                                      </tr>
                                                      @endif
                                                      <tr>
