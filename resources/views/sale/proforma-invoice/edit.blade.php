                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select party-ajax" data-party-type='customer' data-placeholder="Select Customer" id="party_id" name="party_id">
                                                        <option value="{{ $quotation->party->id }}">{{ $quotation->party->company_name }}</option>
                                                    </select>
...
<x-label for="terms_conditions" name="Terms & Conditions" />

<div class="row g-2">

<div class="col-md-6">
<label>Taxes</label>
<input type="text" name="terms[taxes]" class="form-control"
value="{{ $terms['taxes'] ?? '' }}">
</div>

<div class="col-md-6">
<label>Payment</label>
<input type="text" name="terms[payment]" class="form-control"
value="{{ $terms['payment'] ?? '' }}">
</div>

<div class="col-md-6">
<label>F.O.R</label>
<input type="text" name="terms[for]" class="form-control"
value="{{ $terms['for'] ?? '' }}">
</div>

<div class="col-md-6">
<label>Validity</label>
<input type="text" name="terms[validity]" class="form-control"
value="{{ $terms['validity'] ?? '' }}">
</div>

<div class="col-md-6">
<label>Delivery</label>
<input type="text" name="terms[delivery]" class="form-control"
value="{{ $terms['delivery'] ?? '' }}">
</div>

<div class="col-md-6">
<label>Courier Charges</label>
<input type="text" name="terms[courier]" class="form-control"
value="{{ $terms['courier'] ?? '' }}">
</div>

<div class="col-md-12">
<label>Other</label>
<textarea name="terms[other]" class="form-control" rows="2">{{ $terms['other'] ?? '' }}</textarea>
</div>
                                                   ...
                                                   <tbody>
                                                      @if(app('company')['is_enable_carrier_charge'])
                                                       <tr>
                                                         ...
                                                         <td class="w-50">
                                                            <x-input type="text" additionalClasses="text-end cu_numeric" name="shipping_charge" :required="true" placeholder="Shipping Charge" value="{{ $formatNumber->formatWithPrecision(data_get($quotation, 'shipping_charge', 0), comma:false) }}"/>
                                                        </td>
                                                      </tr>
                                                      @endif
                                                      <tr>
