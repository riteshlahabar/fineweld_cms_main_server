                            ...
                            <div class="col-12 col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <x-shipping-address :shippingAddress="$sale->party->shipping_address ?? ''" />
                                                   ...
                                                   <tbody>
                                                      @if(app('company')['is_enable_carrier_charge'])
                                                       <tr>
                                                         ...
                                                         <td class="w-50">
                                                            <x-input type="text" additionalClasses="text-end cu_numeric" name="shipping_charge" :required="true" placeholder="Shipping Charge" value="{{ $formatNumber->formatWithPrecision(data_get($sale, 'shipping_charge', 0), comma:false) }}"/>
                                                        </td>
                                                      </tr>
                                                      @endif
                                                      <tr>
