                            ...
                            <div class="col-12 col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4 row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-select party-ajax" data-party-type='supplier' data-placeholder="Select Supplier" id="party_id" name="party_id">
                                                        <option value="{{ $order->party->id }}">{{ $order->party->company_name }}</option>
                                                    </select>
                                            ...
                                            <x-shipping-address :shippingAddress="$order->party->shipping_address ?? ''" />
...
<td style="width:30%">
    <input type="text" class="form-control term-field"
           name="mode_of_payment"
           value="{{ $note['mode_of_payment'] ?? '' }}">
</td>
