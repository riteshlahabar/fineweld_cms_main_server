...
<tr>
<td style="width:20%"><b>Mode/Terms of Payment</b></td>
<td style="width:30%">
    <input type="text" class="form-control term-field" name="mode_of_payment">
</td>

<td style="width:20%"><b>Other References</b></td>
<td style="width:30%">
    <input type="text" class="form-control term-field" name="other_reference">
</td>
</tr>
...
<td>
    <input type="text" class="form-control term-field" name="destination">
</td>

<td><b>Dispatched Through</b></td>
<td>
    <input type="text" class="form-control term-field" name="dispatch_through">
</td>
</tr>
...
<td colspan="3">
    <input type="text" class="form-control term-field" name="terms_delivery">
</td>
</tr>
...
<input type="hidden" name="note" id="note_combined">
