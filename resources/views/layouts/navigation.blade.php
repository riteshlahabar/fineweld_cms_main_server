...
<li class="{{ request()->is('tickets/products/list') ? 'mm-active' : '' }}">
    <a href="{{ route('products.list') }}">
        <i class='bx bx-radio-circle'></i> Register Product
    </a>
</li>
@endcan
        ...
        <li class="{{ request()->is('tickets/list') ? 'mm-active' : '' }}">
            <a href="{{ route('tickets.list') }}">
                <i class='bx bx-radio-circle'></i> Queue Tickets
            </a>
        </li>
        @endcan
        ...
        {{-- Ticket Status --}}
        @can('ticket.status')
        <li class="{{ request()->is('tickets/closed') ? 'mm-active' : '' }}">
    <a href="{{ route('tickets.closed') }}">
        <i class='bx bx-radio-circle'></i> Closed Ticket
    </a>
</li>
        @endcan
