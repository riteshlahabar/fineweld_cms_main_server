...
<body onload="window.print();">
            ...
            <table class="header">
                <tr>
                    ...
                    <td class="bill-info">
                        ...
                        @endif
                        @if($sale->irn)
                        <span class="cu-fs-16">IRN: {{ $sale->irn }}</span><br>
                        @endif
                        @if($sale->irn_ack_no)
                        <span class="cu-fs-16">Ack No: {{ $sale->irn_ack_no }}</span><br>
                        @endif
                        @if($sale->ewb_no)
                        <span class="cu-fs-16">EWB No: {{ $sale->ewb_no }}</span><br>
                        @endif
                    </td>
                </tr>
            </table>
            <table class="addresses">
                <tr>
                    <td class="address">
                        ...
                        <span>{{ $sale->party?->company_name ?? '-' }}<br>
                        {!! nl2br(e($sale->party?->billing_address ?? '-')) !!}</span>
    ...
    <span>
        {{ $sale->party?->company_name ?? '-' }}<br>
        {!! nl2br(e($sale->party?->shipping_address ?? '-')) !!}
    </span>
</td>
                </tr>
            </table>
