...
<b>Time :</b> {{ $quotation->format_created_time }}

</td>
</tr>

<!-- separation line after quotation details -->
<tr>
...
@if(!empty($terms))
<table class="table table-bordered custom-table table-compact" style="margin-top:15px; width:100%;">
