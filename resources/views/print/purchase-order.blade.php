...
@if($note)
<b>Mode/Terms of Payment:</b> {{ $note['mode_of_payment'] ?? '' }}<br>
<b>Other References:</b> {{ $note['other_reference'] ?? '' }}<br>
<b>Destination:</b> {{ $note['destination'] ?? '' }}<br>
<b>Dispatched Through:</b> {{ $note['dispatch_through'] ?? '' }}<br>
<b>Terms of Delivery:</b> {{ $note['terms_delivery'] ?? '' }}
@endif
