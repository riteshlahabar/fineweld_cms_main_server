...
// First sheet (Items) – always required
$sheetOne = $spreadsheet->getSheet(0);
$data = $sheetOne->toArray();

// Second sheet (Batch) – optional
$dataTwo = [];
    ...
    $dataTwo = $sheetTwo->toArray();
        ...
        try {
            ...
            foreach ($data as $row) {
                ...
                $itemType = strtoupper(trim($row[2]));
...
$itemType = $mapping[$itemType] ?? $itemType;  // required, "Product" or "Service"
