...
class PurchaseController extends Controller
{
    ...
    public function store(PurchaseRequest $request): JsonResponse
    {
        try {
            ...
            $this->partyService->updateShippingAddress(
    $newPurchase->party_id,
    ...
    public function datatableList(Request $request)
    {
        ...
        $data = Purchase::with('user', 'party', 'itemTransaction')
        ...
        return DataTables::of($data)
            ...
            ->addColumn('purchase_invoice_no', function ($row) {
...
->addColumn('party_gstin', function ($row) {
     return $row->party->company_gst ?? '';
})
->addColumn('basic_amount', function ($row) {
    return $this->formatWithPrecision(
        $row->itemTransaction->sum(function ($item) {
...
->addColumn('gst_amount', function ($row) {
    return $this->formatWithPrecision(
        $row->itemTransaction->sum('tax_amount')
    );
})
